        ...
        <>
            <div className="flex-col justify-center items-center space-y-14 mx-48 my-14">
                <div className="border-b-2 pb-3">
                    <h3>プライバシーポリシー</h3>
                    <p>
                        ArtiClear（以下、「当方」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）におけるユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
                    </p>
                </div>
                <div>
                    <h4>お客様から取得する情報</h4>
                    <p>当方は、お客さまから以下の情報を取得します。</p>
                    <p>
                        <ul>
                ...
                <div>
                    ...
                    <p>
                        ...
                        <br />
                        Twitterアカウント :{' '}
                        <Link href="https://twitter.com/kobenisikakatan">
                            https://twitter.com/kobenisikakatan
                        </Link>
                    </p>
                </div>
                <p>
